...
class WindowManager(Tk):
    def __init__(self):
        ...
        GPIO.setup(13, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  # Example GPIO pin for Button A
        GPIO.setup(15, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
        GPIO.add_event_detect(13, GPIO.RISING, callback=lambda x: self.show_frame("MainWindow"), bouncetime=300)
        GPIO.add_event_detect(15, GPIO.RISING, callback=lambda x: self.show_frame("SecondWinSecondWindowdow"), bouncetime=300)
        
    
    def GPIODetected(self, pin):
        print("GPIO DETECTED"+str(pin))

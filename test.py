...
class MainWindow(Frame):
    ...
    def createWidgets(self):
        ...
        label = Label(self, textvariable=self.label_text, font=("Arial", 700), bg='black', fg='white')
...
class WindowManager(Tk):
    ...
    def __init__(self):
        ...
        GPIO.add_event_detect(15, GPIO.RISING, callback=lambda x: self.show_frame("SecondWindow"), bouncetime=300)
